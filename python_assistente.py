...
with st.sidebar:
    ...
    st.markdown("---")
    st.markdown("Desenvolvido para auxiliar em suas dúvidas de programação Python")

    st.markdown("---")
    st.markdown("IAs podem cometer erros")

    
    # Botão de link para enviar e-mail ao suporte

    st.link_button("✉️ E-mail Para o Suporte ", "mailto:laisfontes34@gmail.com")
